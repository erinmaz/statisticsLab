...
Create the following two graphs in a single jamov file (*.omv). Upload this file to Moodle and use the graphs to answer the questions in the homework “quiz” on Moodle. Note that you can attempt the quiz as many times as you like before the due date and only your highest mark will be counted.

Use the EngageNS data to answer the following questions and to create graphs:

i) Respondents were asked to indicate their main form of transportation to get to their main job.  The variable name is WORK_TRANS.  Responses were given on the following response scale: 1 = walk, 2 = bicycle, 3 = personal car, 4 = public transport, 5 = other. 
...
ii) Respondents were asked to rate the overall accessibility of the health care services in the community.  Responses were measured on a 5-point scale: 1 = poor, 2 = fair, 3 = good, 4 = very good, 5 = excellent.
