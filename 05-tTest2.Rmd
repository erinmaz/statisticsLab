...
The dataset described above can be downloaded [here](https://moodle.stfx.ca/mod/resource/view.php?id=843154). What do you think? Should you IMPORT or OPEN? Have the data file open in JAMOVI **before** the start of your lab session.
...
Recruiter ratings for audio job pitches (*M* = 6.63, *SD* = 1.61) are higher than ratings for transcripts of pitches (*M* = 4.65, *SD* = 1.91). This difference is significant, *t*(33.4) = -3.48, *p* < .05, *d* = -1.12 (95% *CI* [-1.85,-0.39]).
