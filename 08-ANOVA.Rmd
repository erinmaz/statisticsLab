...
<div class="marginnote">
This section is largely paraphrased from Discovering Statistics Using IBM Statistics, according to its “All rights reserved” copyright license. Thank you Field, A. (2018) for aiding our understanding of orthogonal contrasts. 
</div>
...
As we can see, even when we consider the violation to the assumption of homogeneity of variance, the *t*-test are significant. There is indeed a difference between Groups 1 and 2 (No-Task Control vs. Reactivation + Tetris), *t*(22.63) = -2.99, *p* < .05, *g* = -1.00; between Groups 2 and 3 (Reactivation + Tetris vs. Tetris Only), *t*(27.96) = -2.52, *p* < .05, *g* = -0.62; and between Groups 2 and 4 (Reactivation + Tetris vs. Reactivation Only), *t*(25.68) = -3.32, *p* < .05, *g* = -0.92.
...
You will use the Moodle submission link to upload your .spv file showing your have completed the appropriate analysis.
