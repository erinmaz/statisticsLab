...
A quirk of JAMOVI is that histograms do not include numbers on the y-axis, which makes them difficult to read. However, bar graphs do include numbers on the y-axis. For small, quasi-interval scales, you can approximate a histogram with a bar graph. The biggest difference is that usually histograms do not have any space between the bars, whereas bar graphs do have space between the bars, but this is not problematic for small, quasi-interval scales.
