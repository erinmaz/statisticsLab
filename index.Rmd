...
## JAMOVI - Week 1 - January 7th, 8th, & 9th 
...
#### Computed Variables - Week 5 - February 11th, 12th, & 13th
...
Notice that the "Stress" scale in the PSYC 291 Survey data dictionary is adapted from the PSS. In the PSYC 291 Survey, respondents were asked about these items, but for the past week, not the past month. The levels of the response options shown in the data dictionary were the same as the PSS (Responses: 0 = never; 1 = almost never; 2 = sometimes; 3 = fairly often; 4 = very often). For some reason, however, the data in the JAMOVI data file you have range from 1 to 5. Again, this demonstrates another good reason for you to always check the data set you have been given against the data dictionary. It seems reasonable that a score of 1 in the JAMOVI file represents "never" and 5 represents "very often," and we will proceed using this idea of the scale anchors. In other words, where you see a value of 1 in the JAMOVI file, it would correspond to a value of 0 (never) on the scale given in the data dictionary. Values of 2 in the JAMOVI file will correspond to a value of 1 (almost never) in the data dictionary. Values of 3 in the JAMOVI file will correspond to a value of 2 (sometimes) in the data dictionary. Values of 4 in the JAMOVI file will correspond to a value of 3 (fairly often) in the data dictionary. Values of 5 in the JAMOVI file will correspond to a value of 4 (very often) in the data dictionary. 
