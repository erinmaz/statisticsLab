...
```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/RepeatingTheFilter.png')
```
...
Changing the filter to VOLUNTEER==2, you will see that the mean number of friends reported by participants who did not volunteer is 4.22.

```{r , echo=FALSE,dev='png'}
knitr::include_graphics('img/MeanFriendsNonVolunteers.png')
```
