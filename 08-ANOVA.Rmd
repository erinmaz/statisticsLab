...
- Chunk 1 (Reactivation + Tetris) vs Chunk 2 (No-Task Control, Tetris Only, and Reactivation Only)
- Chunk 1 (Reactivation + Tetris) vs. Chunk 2 (No-Task Control as well as Reactivation Only)
- Chunk 1 (Reactivation + Tetris) vs. Chunk 2 (No-Task Control)

If you run the unplanned comparisons, assume the assumption of heterogeneity of variance is upheld or met.

Report your result in proper statistical reporting format. What do you conclude? 
...
You will use the Moodle quiz to show your interpretation of the results in one written Results sentence and to answer questions based on what you have learned about follow-up tests.
