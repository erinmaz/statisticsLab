...
2. Plot histograms of life expectancy for both years. How are these distributions different? Note: We are looking for two histograms, one for each year. (Hint: Plot these on the same axes so that they are comparable).
