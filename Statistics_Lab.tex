...
\hypersetup{
            ...
            pdfauthor={Matthew J. C. Crump, Anjali Krishnan, Stephen Volz, and Alla Chavarga; Adapted for PSYC 292, St.~Francis Xavier University, by Erin L. Mazerolle and Sherry Neville-MacLean},
            pdfborder={0 0 0},
            breaklinks=true}
...
\NormalTok{counts <-}\StringTok{ }\NormalTok{nyc_films }\OperatorTok{%>%}
...
\NormalTok{counts <-}\StringTok{ }\NormalTok{nyc_films }\OperatorTok{%>%}
\StringTok{          }\KeywordTok{group_by}\NormalTok{(SubCategoryName) }\OperatorTok{%>%}
...
\KeywordTok{ggplot}\NormalTok{(counts, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x =}\NormalTok{ SubCategoryName, }\DataTypeTok{y =}\NormalTok{ count_of_permits, }
                   ...
                   \DataTypeTok{fill=}\NormalTok{ SubCategoryName )) }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_bar}\NormalTok{(}\DataTypeTok{stat=}\StringTok{"identity"}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{theme_classic}\NormalTok{(}\DataTypeTok{base_size =} \DecValTok{10}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{theme}\NormalTok{(}\DataTypeTok{axis.text.x =} \KeywordTok{element_text}\NormalTok{(}\DataTypeTok{angle =} \DecValTok{90}\NormalTok{, }\DataTypeTok{hjust =} \DecValTok{1}\NormalTok{)) }\OperatorTok{+}
\StringTok{  }\KeywordTok{ylab}\NormalTok{(}\StringTok{"Number of Film Permits"}\NormalTok{) }\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{xlab}\NormalTok{(}\StringTok{"Sub-category of film"}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{ggtitle}\NormalTok{(}\StringTok{"Number of Film permits in NYC by Sub-category"}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{theme}\NormalTok{(}\DataTypeTok{legend.position=}\StringTok{"none"}\NormalTok{) }
\end{Highlighting}
\end{Shaded}
...
\NormalTok{counts <-}\StringTok{ }\NormalTok{nyc_films }\OperatorTok{%>%}
\StringTok{          }\KeywordTok{group_by}\NormalTok{(Borough,Category) }\OperatorTok{%>%}
\StringTok{          }\KeywordTok{summarize}\NormalTok{(}\DataTypeTok{count_of_permits =} \KeywordTok{length}\NormalTok{(Category))}
...
\StringTok{  }\KeywordTok{theme}\NormalTok{(}\DataTypeTok{legend.position=}\StringTok{"none"}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{facet_wrap}\NormalTok{(}\OperatorTok{~}\NormalTok{Borough, }\DataTypeTok{ncol=}\DecValTok{3}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{smaller_df <-}\StringTok{ }\NormalTok{gapminder_df }\OperatorTok{%>%}\StringTok{ }
...
\KeywordTok{ggplot}\NormalTok{(smaller_df, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{y=}\NormalTok{ lifeExp, }\DataTypeTok{x=}\NormalTok{ year))}\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_point}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{smaller_df <-}\StringTok{ }\NormalTok{gapminder_df }\OperatorTok{%>%}\StringTok{ }
\StringTok{                 }\KeywordTok{filter}\NormalTok{(country }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"Canada"}\NormalTok{,}\StringTok{"France"}\NormalTok{,}\StringTok{"Brazil"}\NormalTok{) }\OperatorTok{==}\StringTok{ }\OtherTok{TRUE}\NormalTok{)}

\CommentTok{# plot the new data contained in smaller_df}

\KeywordTok{ggplot}\NormalTok{(smaller_df, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{y=}\NormalTok{ lifeExp, }\DataTypeTok{x=}\NormalTok{ year, }\DataTypeTok{group=}\NormalTok{ country))}\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_point}\NormalTok{()}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{img/1.4.11.png} Notice at the bottom of your window
...
\includegraphics{img/1.4.15.png} The following window will ask which
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{mean}\NormalTok{(my_df[my_df}\OperatorTok{$}\NormalTok{conditions}\OperatorTok{==}\StringTok{"A"}\NormalTok{,]}\OperatorTok{$}\NormalTok{scores)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{mean}\NormalTok{(my_df[my_df}\OperatorTok{$}\NormalTok{conditions}\OperatorTok{==}\StringTok{"B"}\NormalTok{,]}\OperatorTok{$}\NormalTok{scores)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{mean}\NormalTok{(my_df[my_df}\OperatorTok{$}\NormalTok{conditions}\OperatorTok{==}\StringTok{"C"}\NormalTok{,]}\OperatorTok{$}\NormalTok{scores)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{my_df }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(conditions) }\OperatorTok{%>%}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{summary_df <-}\StringTok{ }\NormalTok{my_df }\OperatorTok{%>%}
\StringTok{               }\KeywordTok{group_by}\NormalTok{(conditions) }\OperatorTok{%>%}
\StringTok{               }\KeywordTok{summarise}\NormalTok{(}\DataTypeTok{means =} \KeywordTok{mean}\NormalTok{(scores))}

\NormalTok{knitr}\OperatorTok{::}\KeywordTok{kable}\NormalTok{(summary_df)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{summary_df <-}\StringTok{ }\NormalTok{gapminder_df }\OperatorTok{%>%}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{cor}\NormalTok{(whr_data}\OperatorTok{$}\StringTok{`}\DataTypeTok{Freedom to make life choices}\StringTok{`}\NormalTok{,}
\NormalTok{    whr_data}\OperatorTok{$}\StringTok{`}\DataTypeTok{Confidence in national government}\StringTok{`}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{smaller_df <-}\StringTok{ }\NormalTok{whr_data }\OperatorTok{%>%}
\StringTok{               }\KeywordTok{select}\NormalTok{(country,}
                      \StringTok{`}\DataTypeTok{Freedom to make life choices}\StringTok{`}\NormalTok{,}
                      \StringTok{`}\DataTypeTok{Confidence in national government}\StringTok{`}\NormalTok{) }\OperatorTok{%>%}
\StringTok{               }\KeywordTok{filter}\NormalTok{(}\OperatorTok{!}\KeywordTok{is.na}\NormalTok{(}\StringTok{`}\DataTypeTok{Freedom to make life choices}\StringTok{`}\NormalTok{),}
                      \OperatorTok{!}\KeywordTok{is.na}\NormalTok{(}\StringTok{`}\DataTypeTok{Confidence in national government}\StringTok{`}\NormalTok{))}

\KeywordTok{cor}\NormalTok{(smaller_df}\OperatorTok{$}\StringTok{`}\DataTypeTok{Freedom to make life choices}\StringTok{`}\NormalTok{,}
\NormalTok{    smaller_df}\OperatorTok{$}\StringTok{`}\DataTypeTok{Confidence in national government}\StringTok{`}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\StringTok{               }\KeywordTok{select}\NormalTok{(country,}
                      ...
                      \StringTok{`}\DataTypeTok{Negative affect}\StringTok{`}\NormalTok{) }\OperatorTok{%>%}
\StringTok{               }\KeywordTok{filter}\NormalTok{(}\OperatorTok{!}\KeywordTok{is.na}\NormalTok{(}\StringTok{`}\DataTypeTok{Positive affect}\StringTok{`}\NormalTok{),}
                      \OperatorTok{!}\KeywordTok{is.na}\NormalTok{(}\StringTok{`}\DataTypeTok{Negative affect}\StringTok{`}\NormalTok{))}

\CommentTok{# calcualte correlation}

\KeywordTok{cor}\NormalTok{(smaller_df}\OperatorTok{$}\StringTok{`}\DataTypeTok{Positive affect}\StringTok{`}\NormalTok{,}
\NormalTok{    smaller_df}\OperatorTok{$}\StringTok{`}\DataTypeTok{Negative affect}\StringTok{`}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\includegraphics{img/3.4.20.png} Click OK. SPSS will produce a
correlation table.
...
\NormalTok{sample_means <-}\StringTok{ }\NormalTok{my_df }\OperatorTok{%>%}
\StringTok{                }\KeywordTok{group_by}\NormalTok{(samples) }\OperatorTok{%>%}
\StringTok{                }\KeywordTok{summarise}\NormalTok{(}\DataTypeTok{means=}\KeywordTok{mean}\NormalTok{(scores))}

\NormalTok{knitr}\OperatorTok{::}\KeywordTok{kable}\NormalTok{(sample_means)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{mean}\NormalTok{(sample_means}\OperatorTok{$}\NormalTok{means)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{scores <-}\StringTok{ }\KeywordTok{rnorm}\NormalTok{(}\DecValTok{1000}\OperatorTok{*}\DecValTok{20}\NormalTok{,}\DecValTok{0}\NormalTok{,}\DecValTok{1}\NormalTok{)}
\NormalTok{samples <-}\StringTok{ }\KeywordTok{rep}\NormalTok{(}\DecValTok{1}\OperatorTok{:}\DecValTok{1000}\NormalTok{,}\DataTypeTok{each=}\DecValTok{20}\NormalTok{)}
\NormalTok{my_df <-}\StringTok{ }\KeywordTok{data.frame}\NormalTok{(samples,scores)}
...
\begin{Highlighting}[]
\KeywordTok{library}\NormalTok{(dplyr)}
\NormalTok{experiment_one <-}\StringTok{ }\NormalTok{all_data }\OperatorTok{%>%}\StringTok{ }\KeywordTok{filter}\NormalTok{(exp1}\OperatorTok{==}\DecValTok{1}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{baseline <-}\StringTok{ }\NormalTok{experiment_one}\OperatorTok{$}\NormalTok{Baseline_Proportion_Gaze_to_Singer}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{test_phase <-}\StringTok{ }\NormalTok{experiment_one}\OperatorTok{$}\NormalTok{Test_Proportion_Gaze_to_Singer}
...
\NormalTok{lower_interval<-}\StringTok{ }\NormalTok{t_test_results}\OperatorTok{$}\NormalTok{conf.int[}\DecValTok{1}\NormalTok{]}
\NormalTok{upper_interval<-}\StringTok{ }\NormalTok{t_test_results}\OperatorTok{$}\NormalTok{conf.int[}\DecValTok{2}\NormalTok{]}
...
\includegraphics{img/6.4.13.png} Click {OK}. SPSS will generate an
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{all_data}\OperatorTok{$}\NormalTok{CONDITION}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{all_data}\OperatorTok{$}\NormalTok{CONDITION <-}\StringTok{ }\KeywordTok{as.factor}\NormalTok{(all_data}\OperatorTok{$}\NormalTok{CONDITION)}
\KeywordTok{levels}\NormalTok{(all_data}\OperatorTok{$}\NormalTok{CONDITION) <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"transcript"}\NormalTok{,}\StringTok{"audio"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{descriptive_df <-}\StringTok{ }\NormalTok{all_data }\OperatorTok{%>%}\StringTok{ }
...
\StringTok{                    }\KeywordTok{summarise}\NormalTok{(}\DataTypeTok{means=} \KeywordTok{mean}\NormalTok{(Intellect_Rating),}
                              \DataTypeTok{SEs =} \KeywordTok{sd}\NormalTok{(Intellect_Rating)}\OperatorTok{/}\KeywordTok{sqrt}\NormalTok{(}\KeywordTok{length}\NormalTok{(Intellect_Rating)))}

\CommentTok{# Make the plot}
\KeywordTok{ggplot}\NormalTok{(descriptive_df, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x=}\NormalTok{CONDITION, }\DataTypeTok{y=}\NormalTok{means))}\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{geom_bar}\NormalTok{(}\DataTypeTok{stat=}\StringTok{"identity"}\NormalTok{, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{fill=}\NormalTok{CONDITION))}\OperatorTok{+}\StringTok{ }\CommentTok{# add means}
\StringTok{  }\KeywordTok{geom_errorbar}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{ymin=}\NormalTok{means}\OperatorTok{-}\NormalTok{SEs,               }\CommentTok{# add error bars}
                    \DataTypeTok{ymax=}\NormalTok{means}\OperatorTok{+}\NormalTok{SEs), }\DataTypeTok{width=}\NormalTok{.}\DecValTok{1}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_point}\NormalTok{(}\DataTypeTok{data=}\NormalTok{all_data, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x=}\NormalTok{CONDITION, }\DataTypeTok{y=}\NormalTok{Intellect_Rating), }\DataTypeTok{alpha=}\NormalTok{.}\DecValTok{5}\NormalTok{)}\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_point}\NormalTok{(}\DataTypeTok{alpha=}\NormalTok{.}\DecValTok{25}\NormalTok{)}\OperatorTok{+}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{t.test}\NormalTok{(all_data[all_data}\OperatorTok{$}\NormalTok{CONDITION}\OperatorTok{==}\StringTok{'transcript'}\NormalTok{,]}\OperatorTok{$}\NormalTok{Intellect_Rating,}
\NormalTok{       all_data[all_data}\OperatorTok{$}\NormalTok{CONDITION}\OperatorTok{==}\StringTok{'audio'}\NormalTok{,]}\OperatorTok{$}\NormalTok{Intellect_Rating,}
...
\NormalTok{condition <-}\StringTok{ }\KeywordTok{rep}\NormalTok{(all_data}\OperatorTok{$}\NormalTok{CONDITION,}\DecValTok{3}\NormalTok{)}

\CommentTok{# make a ratings variable with all three ratings in one variable}

\NormalTok{ratings <-}\StringTok{ }\KeywordTok{c}\NormalTok{(all_data}\OperatorTok{$}\NormalTok{Intellect_Rating,}
\NormalTok{             all_data}\OperatorTok{$}\NormalTok{Impression_Rating,}
\NormalTok{             all_data}\OperatorTok{$}\NormalTok{Hire_Rating)}
...
\NormalTok{num_to_repeat <-}\StringTok{ }\KeywordTok{length}\NormalTok{(all_data}\OperatorTok{$}\NormalTok{CONDITION)}
...
\NormalTok{descriptive_all <-}\StringTok{ }\NormalTok{plot_all }\OperatorTok{%>%}\StringTok{ }
\StringTok{                    }\KeywordTok{group_by}\NormalTok{(condition,rating_type) }\OperatorTok{%>%}\StringTok{ }
\StringTok{                    }\KeywordTok{summarise}\NormalTok{(}\DataTypeTok{means=} \KeywordTok{mean}\NormalTok{(ratings),}
                              \DataTypeTok{SEs =} \KeywordTok{sd}\NormalTok{(ratings)}\OperatorTok{/}\KeywordTok{sqrt}\NormalTok{(}\KeywordTok{length}\NormalTok{(ratings)))}

\CommentTok{# Make the plot}

\KeywordTok{ggplot}\NormalTok{(descriptive_all, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x=}\NormalTok{rating_type, }\DataTypeTok{y=}\NormalTok{means, }\DataTypeTok{group=}\NormalTok{condition))}\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{geom_bar}\NormalTok{(}\DataTypeTok{stat=}\StringTok{"identity"}\NormalTok{, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{fill=}\NormalTok{condition), }\DataTypeTok{position=}\StringTok{'dodge'}\NormalTok{)}\OperatorTok{+}\StringTok{ }
\StringTok{  }\KeywordTok{geom_errorbar}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{ymin=}\NormalTok{means}\OperatorTok{-}\NormalTok{SEs,               }
                    \DataTypeTok{ymax=}\NormalTok{means}\OperatorTok{+}\NormalTok{SEs), }
                \DataTypeTok{width=}\NormalTok{.}\DecValTok{1}\NormalTok{, }
                \DataTypeTok{position =} \KeywordTok{position_dodge}\NormalTok{(}\DataTypeTok{width=}\NormalTok{.}\DecValTok{9}\NormalTok{)) }\OperatorTok{+}
...
\begin{Highlighting}[]
\NormalTok{all_data}\OperatorTok{$}\NormalTok{Condition <-}\StringTok{ }\KeywordTok{as.factor}\NormalTok{(all_data}\OperatorTok{$}\NormalTok{Condition)}
\KeywordTok{levels}\NormalTok{(all_data}\OperatorTok{$}\NormalTok{Condition) <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"Control"}\NormalTok{,}
...
\StringTok{                    }\KeywordTok{summarise}\NormalTok{(}\DataTypeTok{means=} \KeywordTok{mean}\NormalTok{(Days_One_to_Seven_Number_of_Intrusions),}
                              \DataTypeTok{SEs =} \KeywordTok{sd}\NormalTok{(Days_One_to_Seven_Number_of_Intrusions)}\OperatorTok{/}\KeywordTok{sqrt}\NormalTok{(}\KeywordTok{length}\NormalTok{(Days_One_to_Seven_Number_of_Intrusions)))}
...
\StringTok{  }\KeywordTok{geom_errorbar}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{ymin=}\NormalTok{means}\OperatorTok{-}\NormalTok{SEs,               }\CommentTok{# add error bars}
                    \DataTypeTok{ymax=}\NormalTok{means}\OperatorTok{+}\NormalTok{SEs), }\DataTypeTok{width=}\NormalTok{.}\DecValTok{1}\NormalTok{) }\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_point}\NormalTok{(}\DataTypeTok{data=}\NormalTok{all_data, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x=}\NormalTok{Condition, }\DataTypeTok{y=}\NormalTok{Days_One_to_Seven_Number_of_Intrusions), }\DataTypeTok{alpha=}\NormalTok{.}\DecValTok{5}\NormalTok{)}\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_point}\NormalTok{(}\DataTypeTok{alpha=}\NormalTok{.}\DecValTok{25}\NormalTok{)}\OperatorTok{+}
...
\NormalTok{knitr}\OperatorTok{::}\KeywordTok{kable}\NormalTok{(descriptive_df)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{comparison_df <-}\StringTok{ }\NormalTok{all_data }\OperatorTok{%>%}\StringTok{ }
\StringTok{                  }\KeywordTok{filter}\NormalTok{(Condition }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{'Control'}\NormalTok{,}\StringTok{'Reactivation_only'}\NormalTok{)}\OperatorTok{==}\OtherTok{TRUE}\NormalTok{)}
                        
\KeywordTok{t.test}\NormalTok{(Days_One_to_Seven_Number_of_Intrusions }\OperatorTok{~}\StringTok{ }\NormalTok{Condition, }
...
\begin{Highlighting}[]
\NormalTok{comparison_df <-}\StringTok{ }\NormalTok{all_data }\OperatorTok{%>%}\StringTok{ }
\StringTok{                  }\KeywordTok{filter}\NormalTok{(Condition }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{'Control'}\NormalTok{,}\StringTok{'Reactivation+Tetris'}\NormalTok{)}\OperatorTok{==}\OtherTok{TRUE}\NormalTok{)}
...
\begin{Highlighting}[]
\NormalTok{comparison_df <-}\StringTok{ }\NormalTok{all_data }\OperatorTok{%>%}\StringTok{ }
\StringTok{                  }\KeywordTok{filter}\NormalTok{(Condition }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{'Control'}\NormalTok{,}\StringTok{'Tetris_only'}\NormalTok{)}\OperatorTok{==}\OtherTok{TRUE}\NormalTok{)}
...
\begin{Highlighting}[]
\NormalTok{comparison_df <-}\StringTok{ }\NormalTok{all_data }\OperatorTok{%>%}\StringTok{ }
\StringTok{                  }\KeywordTok{filter}\NormalTok{(Condition }\OperatorTok{%in%}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{'Tetris_only'}\NormalTok{,}\StringTok{'Reactivation+Tetris'}\NormalTok{)}\OperatorTok{==}\OtherTok{TRUE}\NormalTok{)}
...
\StringTok{             }\KeywordTok{filter}\NormalTok{(Days_One_to_Seven_Number_of_Intrusions }\OperatorTok{<}\StringTok{ }\DecValTok{10}\NormalTok{)}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{hist}\NormalTok{(all_data}\OperatorTok{$}\NormalTok{PureRTs)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{all_data}\OperatorTok{$}\NormalTok{Block<-}\KeywordTok{as.factor}\NormalTok{(all_data}\OperatorTok{$}\NormalTok{Block)}
\KeywordTok{levels}\NormalTok{(all_data}\OperatorTok{$}\NormalTok{Block) <-}\StringTok{ }\KeywordTok{c}\NormalTok{(}\StringTok{"Visible keyboard"}\NormalTok{,}\StringTok{"Covered Keyboard"}\NormalTok{)}

\NormalTok{## get subject mean RTs}

\NormalTok{subject_means <-}\StringTok{ }\NormalTok{all_data }\OperatorTok{%>%}
\StringTok{                 }\KeywordTok{filter}\NormalTok{(Order}\OperatorTok{==}\DecValTok{1}\NormalTok{, Correct}\OperatorTok{==}\DecValTok{1}\NormalTok{, PureRTs}\OperatorTok{<}\DecValTok{5000}\NormalTok{) }\OperatorTok{%>%}
\StringTok{                 }\KeywordTok{group_by}\NormalTok{(Subject, Block, Stimulus) }\OperatorTok{%>%}
\StringTok{                 }\KeywordTok{summarise}\NormalTok{(}\DataTypeTok{mean_rt =} \KeywordTok{mean}\NormalTok{(PureRTs))}

\NormalTok{subject_means}\OperatorTok{$}\NormalTok{Subject<-}\KeywordTok{as.factor}\NormalTok{(subject_means}\OperatorTok{$}\NormalTok{Subject)}
\NormalTok{subject_means}\OperatorTok{$}\NormalTok{Block<-}\KeywordTok{as.factor}\NormalTok{(subject_means}\OperatorTok{$}\NormalTok{Block)}
\NormalTok{subject_means}\OperatorTok{$}\NormalTok{Stimulus<-}\KeywordTok{as.factor}\NormalTok{(subject_means}\OperatorTok{$}\NormalTok{Stimulus)}

\NormalTok{## get condition mean RTs}

\NormalTok{plot_means <-}\StringTok{ }\NormalTok{subject_means }\OperatorTok{%>%}
\StringTok{              }\KeywordTok{group_by}\NormalTok{(Block, Stimulus) }\OperatorTok{%>%}
\StringTok{              }\KeywordTok{summarise}\NormalTok{(}\DataTypeTok{means =} \KeywordTok{mean}\NormalTok{(mean_rt),}
                        \DataTypeTok{SEs =} \KeywordTok{sd}\NormalTok{(mean_rt)}\OperatorTok{/}\KeywordTok{sqrt}\NormalTok{(}\KeywordTok{length}\NormalTok{(mean_rt)))}

\NormalTok{## plot the condition means}

\CommentTok{# re-order stimulus factor for plotting}
\NormalTok{plot_means}\OperatorTok{$}\NormalTok{Stimulus <-}\StringTok{ }\KeywordTok{factor}\NormalTok{(plot_means}\OperatorTok{$}\NormalTok{Stimulus, }\DataTypeTok{levels =} \KeywordTok{c}\NormalTok{(}\StringTok{"Normal"}\NormalTok{, }\StringTok{"Bigrams"}\NormalTok{, }\StringTok{"Random"}\NormalTok{))}
...
\NormalTok{subject_means <-}\StringTok{ }\NormalTok{all_data }\OperatorTok{%>%}
\StringTok{                 }\KeywordTok{filter}\NormalTok{(Order}\OperatorTok{==}\DecValTok{1}\NormalTok{, Correct}\OperatorTok{==}\DecValTok{1}\NormalTok{, PureRTs}\OperatorTok{<}\DecValTok{5000}\NormalTok{) }\OperatorTok{%>%}
\StringTok{                 }\KeywordTok{group_by}\NormalTok{(Subject, Stimulus) }\OperatorTok{%>%}
\StringTok{                 }\KeywordTok{summarise}\NormalTok{(}\DataTypeTok{mean_rt =} \KeywordTok{mean}\NormalTok{(PureRTs))}
...
\NormalTok{plot_means <-}\StringTok{ }\NormalTok{subject_means }\OperatorTok{%>%}
\StringTok{              }\KeywordTok{group_by}\NormalTok{(Stimulus) }\OperatorTok{%>%}
\StringTok{              }\KeywordTok{summarise}\NormalTok{(}\DataTypeTok{means =} \KeywordTok{mean}\NormalTok{(mean_rt),}
                        \DataTypeTok{SEs =} \KeywordTok{sd}\NormalTok{(mean_rt)}\OperatorTok{/}\KeywordTok{sqrt}\NormalTok{(}\KeywordTok{length}\NormalTok{(mean_rt)))}
...
\KeywordTok{ggplot}\NormalTok{(plot_means, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x=}\NormalTok{Stimulus, }\DataTypeTok{y=}\NormalTok{means, }\DataTypeTok{group=}\DecValTok{1}\NormalTok{))}\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_point}\NormalTok{()}\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_line}\NormalTok{(}\DataTypeTok{stat=}\StringTok{"identity"}\NormalTok{)}\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_errorbar}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{ymin=}\NormalTok{means}\OperatorTok{-}\NormalTok{SEs, }\DataTypeTok{ymax=}\NormalTok{means}\OperatorTok{+}\NormalTok{SEs), }\DataTypeTok{width=}\NormalTok{.}\DecValTok{2}\NormalTok{)}\OperatorTok{+}
\StringTok{  }\KeywordTok{theme_classic}\NormalTok{()}\OperatorTok{+}
\StringTok{  }\KeywordTok{ylab}\NormalTok{(}\StringTok{"Mean Reaction Time (ms)"}\NormalTok{)}\OperatorTok{+}
\StringTok{  }\KeywordTok{xlab}\NormalTok{(}\StringTok{"Typing Material"}\NormalTok{)}
...
\NormalTok{subject_means}\OperatorTok{$}\NormalTok{Subject  <-}\StringTok{ }\KeywordTok{as.factor}\NormalTok{(subject_means}\OperatorTok{$}\NormalTok{Subject)}
\NormalTok{subject_means}\OperatorTok{$}\NormalTok{Stimulus <-}\StringTok{ }\KeywordTok{as.factor}\NormalTok{(subject_means}\OperatorTok{$}\NormalTok{Stimulus)}

\CommentTok{# Conduct the anova}

\NormalTok{aov_out <-}\StringTok{ }\KeywordTok{aov}\NormalTok{( mean_rt }\OperatorTok{~}\StringTok{ }\NormalTok{Stimulus }\OperatorTok{+}\StringTok{ }\KeywordTok{Error}\NormalTok{(Subject}\OperatorTok{/}\NormalTok{Stimulus), subject_means)}
...
\NormalTok{knitr}\OperatorTok{::}\KeywordTok{kable}\NormalTok{(plot_means)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{comparison_df <-}\StringTok{ }\NormalTok{subject_means }\OperatorTok{%>%}
\StringTok{                  }\KeywordTok{filter}\NormalTok{(Stimulus }\OperatorTok{!=}\StringTok{ "Random"}\NormalTok{)}

\KeywordTok{t.test}\NormalTok{(mean_rt}\OperatorTok{~}\NormalTok{Stimulus, }
...
\begin{Highlighting}[]
\NormalTok{comparison_df <-}\StringTok{ }\NormalTok{subject_means }\OperatorTok{%>%}
\StringTok{                  }\KeywordTok{filter}\NormalTok{(Stimulus }\OperatorTok{!=}\StringTok{ "Normal"}\NormalTok{)}
...
\begin{Highlighting}[]
\NormalTok{subject_means <-}\StringTok{ }\NormalTok{all_data }\OperatorTok{%>%}
\StringTok{                 }\KeywordTok{filter}\NormalTok{(Order }\OperatorTok{>}\StringTok{ }\DecValTok{1}\NormalTok{, Correct}\OperatorTok{==}\DecValTok{1}\NormalTok{, PureRTs}\OperatorTok{<}\DecValTok{5000}\NormalTok{) }\OperatorTok{%>%}
\StringTok{                 }\KeywordTok{group_by}\NormalTok{(Subject, Stimulus) }\OperatorTok{%>%}
\StringTok{                 }\KeywordTok{summarise}\NormalTok{(}\DataTypeTok{mean_rt =} \KeywordTok{mean}\NormalTok{(PureRTs))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{new_columns <-}\StringTok{ }\KeywordTok{tstrsplit}\NormalTok{(stroop_long}\OperatorTok{$}\NormalTok{Condition, }\StringTok{"_"}\NormalTok{, }\DataTypeTok{names=}\KeywordTok{c}\NormalTok{(}\StringTok{"Congruency"}\NormalTok{,}\StringTok{"Posture"}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{hist}\NormalTok{(stroop_long}\OperatorTok{$}\NormalTok{RTs)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{plot_means <-}\StringTok{ }\NormalTok{stroop_long }\OperatorTok{%>%}
\StringTok{            }\KeywordTok{group_by}\NormalTok{(Congruency,Posture) }\OperatorTok{%>%}
\StringTok{            }\KeywordTok{summarise}\NormalTok{(}\DataTypeTok{mean_RT =} \KeywordTok{mean}\NormalTok{(RTs),}
                      \DataTypeTok{SEM =} \KeywordTok{sd}\NormalTok{(RTs)}\OperatorTok{/}\KeywordTok{sqrt}\NormalTok{(}\KeywordTok{length}\NormalTok{(RTs)))}

\KeywordTok{ggplot}\NormalTok{(plot_means, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x=}\NormalTok{Posture, }\DataTypeTok{y=}\NormalTok{mean_RT, }\DataTypeTok{group=}\NormalTok{Congruency, }\DataTypeTok{fill=}\NormalTok{Congruency))}\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_bar}\NormalTok{(}\DataTypeTok{stat=}\StringTok{"identity"}\NormalTok{, }\DataTypeTok{position=}\StringTok{"dodge"}\NormalTok{)}\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_errorbar}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{ymin=}\NormalTok{mean_RT}\OperatorTok{-}\NormalTok{SEM, }\DataTypeTok{ymax=}\NormalTok{mean_RT}\OperatorTok{+}\NormalTok{SEM), }
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{stroop_long}\OperatorTok{$}\NormalTok{Subject <-}\StringTok{ }\KeywordTok{as.factor}\NormalTok{(stroop_long}\OperatorTok{$}\NormalTok{Subject) }\CommentTok{#convert subject to factor}

\NormalTok{summary_out<-}\KeywordTok{aov}\NormalTok{(RTs }\OperatorTok{~}\StringTok{ }\NormalTok{Congruency}\OperatorTok{*}\NormalTok{Posture }\OperatorTok{+}\StringTok{ }\KeywordTok{Error}\NormalTok{(Subject}\OperatorTok{/}\NormalTok{(Congruency}\OperatorTok{*}\NormalTok{Posture)), stroop_long)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{means_to_compare <-}\StringTok{ }\NormalTok{stroop_long }\OperatorTok{%>%}
\StringTok{                      }\KeywordTok{filter}\NormalTok{(Posture}\OperatorTok{==}\StringTok{"sit"}\NormalTok{)}

\KeywordTok{t.test}\NormalTok{(RTs}\OperatorTok{~}\NormalTok{Congruency, }\DataTypeTok{paired=}\OtherTok{TRUE}\NormalTok{, }\DataTypeTok{var.equal=}\OtherTok{TRUE}\NormalTok{, }\DataTypeTok{data=}\NormalTok{means_to_compare)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\NormalTok{means_to_compare <-}\StringTok{ }\NormalTok{stroop_long }\OperatorTok{%>%}
\StringTok{                      }\KeywordTok{filter}\NormalTok{(Posture}\OperatorTok{==}\StringTok{"stand"}\NormalTok{)}
...
\includegraphics{img/10.4.14.png} You must click {Add} for this table to
be included in your SPSS output. After you do this, Your window should
look like this:

\includegraphics{img/10.4.15.png} Then click {Continue} and {OK}. Your
...
\includegraphics{img/10.4.17.png} You can see from this output that:
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{length}\NormalTok{(}\KeywordTok{unique}\NormalTok{(all_data}\OperatorTok{$}\NormalTok{labID))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{subjects <-}\StringTok{ }\KeywordTok{as.factor}\NormalTok{(}\KeywordTok{c}\NormalTok{(all_data}\OperatorTok{$}\NormalTok{labID,all_data}\OperatorTok{$}\NormalTok{labID))}
\NormalTok{memory_accuracy <-}\StringTok{ }\KeywordTok{c}\NormalTok{(all_data}\OperatorTok{$}\NormalTok{vpercent,all_data}\OperatorTok{$}\NormalTok{apercent)}
...
\NormalTok{camera <-}\StringTok{ }\KeywordTok{as.factor}\NormalTok{(}\KeywordTok{c}\NormalTok{(all_data}\OperatorTok{$}\NormalTok{condition,all_data}\OperatorTok{$}\NormalTok{condition))}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{hist}\NormalTok{(new_data}\OperatorTok{$}\NormalTok{memory_accuracy)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{range}\NormalTok{(new_data}\OperatorTok{$}\NormalTok{memory_accuracy)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{plot_means <-}\StringTok{ }\NormalTok{new_data }\OperatorTok{%>%}
\StringTok{            }\KeywordTok{group_by}\NormalTok{(memory_task,camera) }\OperatorTok{%>%}
\StringTok{            }\KeywordTok{summarise}\NormalTok{(}\DataTypeTok{mean_accuracy =} \KeywordTok{mean}\NormalTok{(memory_accuracy),}
                      \DataTypeTok{SEM =} \KeywordTok{sd}\NormalTok{(memory_accuracy)}\OperatorTok{/}\KeywordTok{sqrt}\NormalTok{(}\KeywordTok{length}\NormalTok{(memory_accuracy)))}

\KeywordTok{ggplot}\NormalTok{(plot_means, }\KeywordTok{aes}\NormalTok{(}\DataTypeTok{x=}\NormalTok{memory_task, }\DataTypeTok{y=}\NormalTok{mean_accuracy, }\DataTypeTok{group=}\NormalTok{camera, }\DataTypeTok{fill=}\NormalTok{camera))}\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_bar}\NormalTok{(}\DataTypeTok{stat=}\StringTok{"identity"}\NormalTok{, }\DataTypeTok{position=}\StringTok{"dodge"}\NormalTok{)}\OperatorTok{+}
\StringTok{  }\KeywordTok{geom_errorbar}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{ymin=}\NormalTok{mean_accuracy}\OperatorTok{-}\NormalTok{SEM, }\DataTypeTok{ymax=}\NormalTok{mean_accuracy}\OperatorTok{+}\NormalTok{SEM), }
                \DataTypeTok{position=}\KeywordTok{position_dodge}\NormalTok{(}\DataTypeTok{width=}\FloatTok{0.9}\NormalTok{),}
                \DataTypeTok{width=}\NormalTok{.}\DecValTok{2}\NormalTok{)}\OperatorTok{+}
\StringTok{  }\KeywordTok{theme_classic}\NormalTok{()}\OperatorTok{+}
