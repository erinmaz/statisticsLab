...
The dataset described above can be downloaded [here](INCLUDE A LINK). IMPORT OR OPEN? Have the data file open in JAMOVI **before** the start of your lab session.
